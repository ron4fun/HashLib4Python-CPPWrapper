...
class GostTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.gost = HashFactory.PyCrypto.CreateGost
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.gost(DefaultData, 0, HMACLongStringKey, 1)
...
class Grindahl256TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.grindahl256 = HashFactory.PyCrypto.CreateGrindahl256
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.grindahl256(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.grindahl256(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.grindahl256(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.grindahl256(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.grindahl256("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.grindahl256(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.grindahl256(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Grindahl512TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.grindahl512 = HashFactory.PyCrypto.CreateGrindahl512
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.grindahl512(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.grindahl512(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.grindahl512(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.grindahl512(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.grindahl512("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.grindahl512(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.grindahl512(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)
        

class HAS160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.has160 = HashFactory.PyCrypto.CreateHAS160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.has160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.has160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.has160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.has160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.has160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.has160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.has160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_3_128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_3_128 = HashFactory.PyCrypto.CreateHaval_3_128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_3_128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_3_128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_3_128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_3_128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_3_128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_3_128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_3_128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_4_128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_4_128 = HashFactory.PyCrypto.CreateHaval_4_128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_4_128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_4_128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_4_128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_4_128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_4_128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_4_128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_4_128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_5_128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_5_128 = HashFactory.PyCrypto.CreateHaval_5_128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_5_128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_5_128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_5_128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_5_128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_5_128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_5_128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_5_128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_3_160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_3_160 = HashFactory.PyCrypto.CreateHaval_3_160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_3_160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_3_160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_3_160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_3_160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_3_160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_3_160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_3_160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_4_160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_4_160 = HashFactory.PyCrypto.CreateHaval_4_160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_4_160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_4_160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_4_160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_4_160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_4_160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_4_160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_4_160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_5_160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_5_160 = HashFactory.PyCrypto.CreateHaval_5_160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_5_160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_5_160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_5_160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_5_160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_5_160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_5_160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_5_160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_3_192TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_3_192 = HashFactory.PyCrypto.CreateHaval_3_192
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_3_192(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_3_192(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_3_192(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_3_192(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_3_192("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_3_192(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_3_192(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_4_192TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_4_192 = HashFactory.PyCrypto.CreateHaval_4_192
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_4_192(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_4_192(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_4_192(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_4_192(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_4_192("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_4_192(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_4_192(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_5_192TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_5_192 = HashFactory.PyCrypto.CreateHaval_5_192
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_5_192(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_5_192(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_5_192(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_5_192(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_5_192("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_5_192(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_5_192(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_3_224TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_3_224 = HashFactory.PyCrypto.CreateHaval_3_224
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_3_224(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_3_224(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_3_224(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_3_224(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_3_224("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_3_224(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_3_224(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_4_224TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_4_224 = HashFactory.PyCrypto.CreateHaval_4_224
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_4_224(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_4_224(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_4_224(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_4_224(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_4_224("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_4_224(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_4_224(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_5_224TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_5_224 = HashFactory.PyCrypto.CreateHaval_5_224
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_5_224(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_5_224(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_5_224(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_5_224(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_5_224("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_5_224(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_5_224(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_3_256TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_3_256 = HashFactory.PyCrypto.CreateHaval_3_256
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_3_256(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_3_256(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_3_256(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_3_256(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_3_256("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_3_256(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_3_256(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_4_256TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_4_256 = HashFactory.PyCrypto.CreateHaval_4_256
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_4_256(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_4_256(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_4_256(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_4_256(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_4_256("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_4_256(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_4_256(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Haval_5_256TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.haval_5_256 = HashFactory.PyCrypto.CreateHaval_5_256
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.haval_5_256(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.haval_5_256(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.haval_5_256(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.haval_5_256(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.haval_5_256("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.haval_5_256(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.haval_5_256(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)
...
class MD2TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.md2 = HashFactory.PyCrypto.CreateMD2
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.md2(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.md2(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.md2(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.md2(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.md2("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.md2(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.md2(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)
...
class MD4TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.md4 = HashFactory.PyCrypto.CreateMD4
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.md4(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.md4(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.md4(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.md4(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.md4("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.md4(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.md4(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)
...
class MD5TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.md5 = HashFactory.PyCrypto.CreateMD5
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.md5(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.md5(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.md5(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.md5(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.md5("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.md5(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.md5(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class PanamaTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.panama = HashFactory.PyCrypto.CreatePanama
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.panama(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.panama(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.panama(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.panama(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.panama("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.panama(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.panama(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class RadioGatun32TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.radioGatun32 = HashFactory.PyCrypto.CreateRadioGatun32
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.radioGatun32(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.radioGatun32(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.radioGatun32(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.radioGatun32(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.radioGatun32("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.radioGatun32(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.radioGatun32(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class RadioGatun64TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.radioGatun64 = HashFactory.PyCrypto.CreateRadioGatun64
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.radioGatun64(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.radioGatun64(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.radioGatun64(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.radioGatun64(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.radioGatun64("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.radioGatun64(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.radioGatun64(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class RIPEMDTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.ripemd = HashFactory.PyCrypto.CreateRIPEMD
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.ripemd(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.ripemd(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.ripemd(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.ripemd(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.ripemd("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.ripemd(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.ripemd(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class RIPEMD128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.ripemd128 = HashFactory.PyCrypto.CreateRIPEMD128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.ripemd128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.ripemd128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.ripemd128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.ripemd128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.ripemd128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.ripemd128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.ripemd128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)
...
class RIPEMD160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.ripemd160 = HashFactory.PyCrypto.CreateRIPEMD160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.ripemd160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.ripemd160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.ripemd160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.ripemd160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.ripemd160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.ripemd160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.ripemd160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class RIPEMD256TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.ripemd256 = HashFactory.PyCrypto.CreateRIPEMD256
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.ripemd256(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.ripemd256(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.ripemd256(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.ripemd256(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.ripemd256("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.ripemd256(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.ripemd256(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class RIPEMD320TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.ripemd320 = HashFactory.PyCrypto.CreateRIPEMD320
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.ripemd320(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.ripemd320(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.ripemd320(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.ripemd320(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.ripemd320("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.ripemd320(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.ripemd320(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)
...
class SHA0TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.sha0 = HashFactory.PyCrypto.CreateSHA0
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.sha0(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.sha0(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.sha0(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.sha0(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.sha0("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.sha0(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.sha0(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)
...
class SHA1TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.sha1 = HashFactory.PyCrypto.CreateSHA1
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.sha1(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.sha1(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.sha1(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.sha1(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.sha1("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.sha1(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.sha1(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class SHA2_224TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.sha2_224 = HashFactory.PyCrypto.CreateSHA2_224
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.sha2_224(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.sha2_224(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.sha2_224(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.sha2_224(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.sha2_224("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.sha2_224(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.sha2_224(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class SHA2_256TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.sha2_256 = HashFactory.PyCrypto.CreateSHA2_256
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.sha2_256(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.sha2_256(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.sha2_256(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.sha2_256(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.sha2_256("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.sha2_256(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.sha2_256(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class SHA2_384TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.sha2_384 = HashFactory.PyCrypto.CreateSHA2_384
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.sha2_384(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.sha2_384(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.sha2_384(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.sha2_384(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.sha2_384("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.sha2_384(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.sha2_384(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class SHA2_512TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.sha2_512 = HashFactory.PyCrypto.CreateSHA2_512
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.sha2_512(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.sha2_512(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.sha2_512(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.sha2_512(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.sha2_512("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.sha2_512(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.sha2_512(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class SHA2_512_224TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.sha2_512_224 = HashFactory.PyCrypto.CreateSHA2_512_224
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.sha2_512_224(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.sha2_512_224(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.sha2_512_224(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.sha2_512_224(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.sha2_512_224("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.sha2_512_224(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.sha2_512_224(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class SHA2_512_256TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.sha2_512_256 = HashFactory.PyCrypto.CreateSHA2_512_256
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.sha2_512_256(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.sha2_512_256(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.sha2_512_256(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.sha2_512_256(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.sha2_512_256("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.sha2_512_256(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.sha2_512_256(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Snefru_8_256TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.snefru_8_256 = HashFactory.PyCrypto.CreateSnefru_8_256
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.snefru_8_256(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.snefru_8_256(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.snefru_8_256(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.snefru_8_256(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.snefru_8_256("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.snefru_8_256(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.snefru_8_256(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Snefru_8_128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.snefru_8_128 = HashFactory.PyCrypto.CreateSnefru_8_128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.snefru_8_128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.snefru_8_128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.snefru_8_128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.snefru_8_128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.snefru_8_128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.snefru_8_128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.snefru_8_128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger_3_128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger_3_128 = HashFactory.PyCrypto.CreateTiger_3_128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger_3_128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger_3_128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger_3_128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger_3_128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger_3_128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger_3_128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger_3_128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger_4_128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger_4_128 = HashFactory.PyCrypto.CreateTiger_4_128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger_4_128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger_4_128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger_4_128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger_4_128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger_4_128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger_4_128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger_4_128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger_5_128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger_5_128 = HashFactory.PyCrypto.CreateTiger_5_128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger_5_128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger_5_128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger_5_128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger_5_128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger_5_128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger_5_128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger_5_128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger_3_160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger_3_160 = HashFactory.PyCrypto.CreateTiger_3_160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger_3_160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger_3_160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger_3_160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger_3_160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger_3_160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger_3_160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger_3_160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger_4_160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger_4_160 = HashFactory.PyCrypto.CreateTiger_4_160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger_4_160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger_4_160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger_4_160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger_4_160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger_4_160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger_4_160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger_4_160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger_5_160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger_5_160 = HashFactory.PyCrypto.CreateTiger_5_160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger_5_160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger_5_160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger_5_160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger_5_160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger_5_160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger_5_160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger_5_160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger_3_192TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger_3_192 = HashFactory.PyCrypto.CreateTiger_3_192
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger_3_192(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger_3_192(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger_3_192(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger_3_192(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger_3_192("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger_3_192(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger_3_192(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger_4_192TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger_4_192 = HashFactory.PyCrypto.CreateTiger_4_192
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger_4_192(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger_4_192(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger_4_192(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger_4_192(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger_4_192("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger_4_192(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger_4_192(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger_5_192TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger_5_192 = HashFactory.PyCrypto.CreateTiger_5_192
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger_5_192(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger_5_192(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger_5_192(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger_5_192(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger_5_192("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger_5_192(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger_5_192(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger2_3_128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger2_3_128 = HashFactory.PyCrypto.CreateTiger2_3_128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger2_3_128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger2_3_128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger2_3_128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger2_3_128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger2_3_128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger2_3_128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger2_3_128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger2_4_128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger2_4_128 = HashFactory.PyCrypto.CreateTiger2_4_128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger2_4_128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger2_4_128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger2_4_128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger2_4_128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger2_4_128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger2_4_128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger2_4_128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger2_5_128TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger2_5_128 = HashFactory.PyCrypto.CreateTiger2_5_128
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger2_5_128(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger2_5_128(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger2_5_128(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger2_5_128(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger2_5_128("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger2_5_128(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger2_5_128(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger2_3_160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger2_3_160 = HashFactory.PyCrypto.CreateTiger2_3_160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger2_3_160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger2_3_160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger2_3_160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger2_3_160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger2_3_160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger2_3_160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger2_3_160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger2_4_160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger2_4_160 = HashFactory.PyCrypto.CreateTiger2_4_160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger2_4_160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger2_4_160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger2_4_160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger2_4_160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger2_4_160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger2_4_160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger2_4_160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger2_5_160TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger2_5_160 = HashFactory.PyCrypto.CreateTiger2_5_160
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger2_5_160(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger2_5_160(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger2_5_160(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger2_5_160(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger2_5_160("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger2_5_160(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger2_5_160(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger2_3_192TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger2_3_192 = HashFactory.PyCrypto.CreateTiger2_3_192
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger2_3_192(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger2_3_192(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger2_3_192(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger2_3_192(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger2_3_192("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger2_3_192(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger2_3_192(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger2_4_192TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger2_4_192 = HashFactory.PyCrypto.CreateTiger2_4_192
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger2_4_192(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger2_4_192(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger2_4_192(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger2_4_192(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger2_4_192("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger2_4_192(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger2_4_192(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)


class Tiger2_5_192TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.tiger2_5_192 = HashFactory.PyCrypto.CreateTiger2_5_192
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.tiger2_5_192(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.tiger2_5_192(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.tiger2_5_192(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.tiger2_5_192(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.tiger2_5_192("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.tiger2_5_192(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.tiger2_5_192(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)
...
class WhirlPoolTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.whirlpool = HashFactory.PyCrypto.CreateWhirlPool
        
    def test_HMACWithDefaultDataAndLongKey(self):
        ActualString = self.whirlpool(DefaultData, 0, HMACLongStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithLongKey == ActualString)

    def test_HMACWithDefaultDataAndShortKey(self):
        ActualString = self.whirlpool(DefaultData, 0, HMACShortStringKey, 1)
        self.assertTrue(self.ExpectedHashOfDefaultDataWithHMACWithShortKey == ActualString)

    def test_TestBytesabcde(self):
        ActualString = self.whirlpool(Bytesabcde, 0)
        self.assertTrue(self.ExpectedHashOfabcde == ActualString)

    def test_TestDefaultData(self):
        ActualString = self.whirlpool(DefaultData, 0)
        self.assertTrue(self.ExpectedHashOfDefaultData == ActualString)

    def test_TestEmptyStream(self):
        ActualString = self.whirlpool("EmptyFile.txt", 1)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestEmptyString(self):
        ActualString = self.whirlpool(EmptyData, 0)
        self.assertTrue(self.ExpectedHashOfEmptyData == ActualString)

    def test_TestOnetoNine(self):
        ActualString = self.whirlpool(OnetoNine, 0)
        self.assertTrue(self.ExpectedHashOfOnetoNine == ActualString)
